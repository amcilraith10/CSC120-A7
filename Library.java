...
public class Library extends Building {
     ...
     *  @param nBooks Number of books in the library
     */
    public Library(String name, String address, int nFloors, int nBooks) {
  ...
  public boolean isAvailable(String title){ 
    if (collection.contains(title)) {
      ...
      System.err.println("This book is not in our collection");
      return false;
    }
  }
  ...
  public void printCollection(){
    ...
    public static void main(String[] args) {
      Library x = new Library("Nielson","Chapin Drive",4, 10000);
